...
FailedSafe outcomes.  It is a reference for transaction semantics, not a
...
performance result.  Real plugin receipts may replace the synthetic inputs in
the planned evaluation without changing the gate protocol.

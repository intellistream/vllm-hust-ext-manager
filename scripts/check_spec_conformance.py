...
def main() -> int:
    ...
    for name in ("invalid-namespace.json", "invalid-missing-process-evidence.json"):
        ...
        if not errors: raise SystemExit(f"expected invalid fixture to fail: {name}")
    ...
    print("ECPA 0.1 draft: valid example accepted, 2 invalid examples rejected, corpus valid")
    return 0

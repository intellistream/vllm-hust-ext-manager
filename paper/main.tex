...
scaling, and lifecycle observability (Figure~\ref{fig:case-coverage}).  BidKV is
...
\foreach \y/\name in {0/BidKV, -1/{DiffSpec / vSpec}, -2/LatchMoE, -3/KVCompress, -4/{Lifecycle profiler}, -5/BetterScale, -6/TraceLoom, -7/DLA}
...
\draw[fill=ecpablue] (1.68,-2.27) rectangle (2.32,-1.73);
\draw[fill=ecpablue] (1.68,-3.27) rectangle (2.32,-2.73);
...
\draw[fill=ecpablue] (1.68,-5.27) rectangle (2.32,-4.73);
\draw[fill=ecpablue] (0.68,-6.27) rectangle (1.32,-5.73);
\draw[fill=ecpablue] (1.68,-6.27) rectangle (2.32,-5.73);
\draw[dashed,thick,fill=ecpablue!35] (-0.32,-7.27) rectangle (0.32,-6.73);
\draw[dashed,thick,fill=ecpablue!35] (0.68,-7.27) rectangle (1.32,-6.73);

\node[anchor=west] at (-0.30,-8.05) {\tikz\draw[fill=ecpablue] (0,0) rectangle (.18,.18); observed integration surface};
\node[anchor=west] at (1.55,-8.05) {\tikz\draw[dashed,thick,fill=ecpablue!35] (0,0) rectangle (.18,.18); namespace/adaptation gap};
\end{tikzpicture}
\caption{Representative integration surfaces in the 24-MOD page population.
Solid cells are source-observed host/process surfaces; dashed DLA cells mark a
namespace/adaptation gap, not a successful activation. Empty cells do not imply
that a MOD was omitted from the audit.}
\label{fig:case-coverage}
\end{figure*}

\begin{table*}[t]
\centering\scriptsize
\caption{All 24 page MODs were inspected at their frozen repository heads. ``Pass''
is package or repository-local CPU/source evidence, never an NPU or runtime-effect claim.}
\begin{tabularx}{\textwidth}{@{}l l l X@{}}
\toprule
MOD & Integration surface & Package & Local source/CPU result \\
\midrule
BidKV & ECPA bundle & pass & 385 passed, 25 skipped \\
DiffSpec & ECPA bundle + general plugin & pass & environment-blocked at Ascend/HCCL import \\
vSpec & ECPA bundle + general plugin & pass & environment-blocked at vLLM Ascend/HCCL import \\
LatchMoE & ECPA bundle + general plugin & pass & environment-blocked at vLLM Ascend import \\
Adaptive Quantized KV & ECPA bundle & pass & 36 passed, 2 skipped \\
Quant Runtime Descriptor & ECPA bundle & pass & 7 passed \\
KVCompress & ECPA bundle + general plugin & pass & 110 passed, 1 skipped; 4 host/NPU-blocked \\
KV Tiering & source scaffold & n/a & no automated tests \\
K-Norm & source scaffold & n/a & no automated tests \\
PyramidKV & ECPA bundle & pass & 33 passed \\
Quantized KV Cache & general plugin & pass & 8 passed, 2 skipped \\
SimLLM & ECPA bundle & pass & 5 passed \\
Unified Communication & ECPA bundle & pass & 4 passed \\
Split Batch / Full Graph & ECPA bundle & pass & 4 passed \\
KV Transfer Observability & ECPA bundle & pass & 125 passed \\
Layered Prefill & ECPA bundle & pass & 5 passed \\
Activation Sparsity & ECPA bundle & pass & 4 passed \\
Pipeline Microbatch & ECPA bundle & pass & 8 passed \\
QoS Scheduler & ECPA bundle & pass & 4 passed \\
BetterScale & direct worker class & qualified staging required & 97 passed, 10 subtests \\
Request Lifecycle Profiler & general plugin & pass & 234 passed, 9 skipped \\
KV Materialization Control & general plugin & pass & 83 passed; 3 host/HCCL-blocked \\
DLA & near-miss bundle namespace & pass & 16 passed, 1 skipped \\
TraceLoom & direct scheduler/analyzer & pass & 50/50 native tests passed \\
\bottomrule
\end{tabularx}
\label{tab:all-workshop-mods}
\end{table*}
...
Page population & \ECPAWorkshopMods{} frozen MOD heads; \ECPAWorkshopBundleNamespace{}
ECPA bundles & observed \\
Planner seed binding & \ECPASourceRepositories{} repositories and
...
frozen composition cases over \ECPAPlannerSeedExtensions{} seed extensions.
